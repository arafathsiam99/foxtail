...
const SingleEvent = () => {
  return (
    <div className="m-7 bg-white  shadow-xl">
      ...
      <div className="px-4 py-2">
        <h3 className="text-2xl font-sans font-medium leading-6	 ">
          Curabitur suscipit vestibulum urna id tincidunt.
        </h3>
        <div className="flex text-gray-500 sm:flex-col md:flex-row ">
          <div>
            ...
            <div className="flex py-1">
              ...
              <p>Date: 21.12.2022</p>
              <p className="ml-5">Time: 04.30pm</p>
            </div>
            <div className="flex py-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Ticket Price: $99.00</p>
            </div>
          </div>
          <div className="  flex justify-center items-center">
            <div className="flex mt-7 ml-20 -space-x-4">
              <img
                className="w-14 h-14 rounded-full border-4  dark:border-slate-600"
            ...
            <div className=" ml-3 mt-5 text-xl font-medium">
              <h1>+30</h1>
            </div>
          </div>
        </div>
